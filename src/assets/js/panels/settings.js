...
class Settings {
        ...
        document.querySelector('.accounts-list').addEventListener('click', async e => {
            ...
            try {
                ...
                if (e.target.classList.contains('account')) {
                    ...
                    if (id == 'add') {
                        document.querySelector('.cancel-home').style.display = 'En linea'
    ...
    async javaPath() {
        ...
        let configClient = await this.db.readData('configClient')
        let javaPath = configClient?.java_config?.java_path || 'Utilice la versión de Java con el launcher';
        ...
        document.querySelector(".java-path-reset").addEventListener("click", async () => {
            let configClient = await this.db.readData('configClient')
            javaPathInputTxt.value = 'Utilice la versión de Java con el launcher';
